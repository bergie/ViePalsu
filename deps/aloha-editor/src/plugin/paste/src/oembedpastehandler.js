 ...
 */
GENTICS.Aloha.PastePlugin.oEmbedPasteHandler = new GENTICS.Aloha.PastePlugin.PasteHandler();

/**
 * Handle the pasting. Try to detect content pasted from word and transform to clean html
 * @param jqPasteDiv
 */
GENTICS.Aloha.PastePlugin.oEmbedPasteHandler.handlePaste = function(jqPasteDiv) {
 ...
 */
GENTICS.Aloha.PastePlugin.oEmbedPasteHandler.replaceoEmbedContent = function (jqPasteDiv) {
